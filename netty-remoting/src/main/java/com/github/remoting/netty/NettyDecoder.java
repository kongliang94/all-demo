...
import com.github.remoting.common.JsonUtil;
import com.github.remoting.common.RemotingUtil;
...
public class NettyDecoder extends LengthFieldBasedFrameDecoder {
    ...
    public Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        try {
            ...
            RemotingCommand cmd = JsonUtil.toObject(RemotingCommand.class,new String(property));
