package com.github.springbootshirodemo.service.impl;
...
import com.github.springbootshirodemo.config.shiro.UserRealm;
import com.github.springbootshirodemo.exception.CustomException;
import com.github.springbootshirodemo.mapper.UserMapper;
import com.github.springbootshirodemo.model.QueryRequest;
import com.github.springbootshirodemo.model.entity.User;
import com.github.springbootshirodemo.model.entity.UserRole;
import com.github.springbootshirodemo.service.IUserRoleService;
import com.github.springbootshirodemo.service.IUserService;
import com.github.springbootshirodemo.common.util.FebsUtil;
import com.github.springbootshirodemo.common.util.MD5Util;
import com.github.springbootshirodemo.common.util.SortUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void regist(String username, String password) {
        ...
        ur.setRoleId(Constant.REGISTER_ROLE_ID);
    ...
    public void updateProfile(User user) {
        ...
        if (isCurrentUser(user.getId())) {
            ...
            throw new CustomException("您无权修改别人的账号信息！");
        }
    }
