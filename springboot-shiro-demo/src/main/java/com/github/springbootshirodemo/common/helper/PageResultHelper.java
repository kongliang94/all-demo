package com.github.springbootshirodemo.common.helper;

import com.github.springbootshirodemo.common.model.PageResultModel;

/**
 * 分页结果返回封装帮助工具类
 *
 * <p>
 *     该工具类操作的实体类是：{@link PageResultModel}
 * </p>
 *
 * <p>
 *     我们提供了如下三个方法：
...
public class PageResultHelper {
     ...
     * 成功，携带描述信息
     * @param message  信息
     * @return 返回结果封装 {@link PageResultModel}
     * @since 2.0.2
     */
