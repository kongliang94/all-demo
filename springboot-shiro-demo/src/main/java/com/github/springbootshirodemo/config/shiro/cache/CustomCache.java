package com.github.springbootshirodemo.config.shiro.cache;
...
import com.github.springbootshirodemo.common.util.SerializableUtil;
...
public class CustomCache<K,V> implements Cache<K,V> {
    ...
    public Object get(Object key) throws CacheException {
        log.info("======{}=======",JedisUtil.exists(this.getKey(key)));
