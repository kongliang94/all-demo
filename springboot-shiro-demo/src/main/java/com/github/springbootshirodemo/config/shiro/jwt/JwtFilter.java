package com.github.springbootshirodemo.config.shiro.jwt;

import com.auth0.jwt.exceptions.SignatureVerificationException;
import com.auth0.jwt.exceptions.TokenExpiredException;
import com.github.springbootshirodemo.common.Constant;
import com.github.springbootshirodemo.common.helper.ResultHelper;
import com.github.springbootshirodemo.common.util.JedisUtil;
import com.github.springbootshirodemo.common.util.JsonConvertUtil;
import com.github.springbootshirodemo.common.util.JwtUtil;
import com.github.springbootshirodemo.common.util.PropertiesUtil;
...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) throws Exception {
        ...
        BearerToken token = new BearerToken(this.getAuthzHeader(request));
    ...
    private boolean refreshToken(ServletRequest request, ServletResponse response) {
        ...
        if (JedisUtil.exists(Constant.PREFIX_SHIRO_REFRESH_TOKEN + account)) {
            ...
            if (JwtUtil.getClaim(token, Constant.CURRENT_TIME_MILLIS).equals(currentTimeMillisRedis)) {
                ...
                // 使用shiro封装的BearerToken,无需定义JwtToken
    ...
    private void response401(ServletResponse response, String msg) {
        ...
        try (PrintWriter out = httpServletResponse.getWriter()) {
            String data = JsonConvertUtil.objectToJson(ResultHelper.error(HttpStatus.UNAUTHORIZED.value()+" 无权访问(Unauthorized):" + msg));
            out.append(data);
        } catch (IOException e) {
