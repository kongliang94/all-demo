...
public class MathUsage {
    public static void main(String[] args) {
        ...
        List<String> vs= Arrays.asList("0.33", "1.33", "0.27333", "0.3", "0.501",
                "0.444", "0.44");
        Min min = new Min();
        Max max = new Max();
        ...
        double[] doubles = new double[vs.size()];
        double[] dbl = vs.stream()
                .mapToDouble(StrMath::strToDouble)
                .toArray();
        System.out.println("min: " + min.evaluate(dbl));
...
class StrMath {
    ...
    public static double applyAsDouble(String value) {
